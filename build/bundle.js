...
/* binding between React and Redux */
...
(0, _reactDom.render)(provider, document.querySelector('#root'));
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(12),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),ha=__webpack_require__(16),ia=__webpack_require__(17),C=__webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24), __webpack_require__(60)(module)))
...
var _actionCreators = __webpack_require__(70);
...
var addContact = exports.addContact = function addContact(name, item) {
  return {
    type: 'ADD_CONTACT',
    name: name,
    item: item
...
var editContact = exports.editContact = function editContact(oldName, newName, item) {
  return {
    type: 'EDIT_CONTACT',
    oldName: oldName,
    newName: newName,
...
var removeContact = exports.removeContact = function removeContact(name) {
  return {
    type: 'REMOVE_CONTACT',
    name: name
  };
...
var updateQueryString = exports.updateQueryString = function updateQueryString(queryString) {
  return {
...
var Main = function (_React$Component) {
  ...
  _createClass(Main, [{
    key: 'getMatches',
    value: function getMatches(queryString) {
      var contacts = Array.from(this.props.contacts);
      // Search globally, case-insensitive
      var regex = new RegExp(queryString, 'gi');

      var matchArray = contacts.filter(function (item) {
        var _item = _slicedToArray(item, 2),
            key = _item[0],
            value = _item[1];

        return key.match(regex) || value.info.match(regex);
      });
      return matchArray;
    }
  }, {
    ...
    value: function loadSamples() {
      ...
      var url = './client/data/sample-data.json';
      var samples = [];
      ...
      fetch(url).then(function (response) {
        ...
        return samples.push.apply(samples, _toConsumableArray(data));
      }).then(function () {
        // Add sample data to contacts in Redux
        samples.forEach(function (item) {
          return _this2.props.addContact(item.name, item);
        });
        console.log(_this2.props.contacts);
    ...
    key: 'renderContact',
    value: function renderContact(item) {
      var _item2 = _slicedToArray(item, 2),
          key = _item2[0],
          value = _item2[1];

      return _react2.default.createElement(_Contact2.default, _extends({ key: key }, value, {
    ...
    value: function render() {
      ...
      var matchArray = this.getMatches(this.props.queryString);
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          matchArray.map(function (item) {
            return _this3.renderContact(item);
          })
        ),
...
var Footer = function Footer() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'p',
      null,
      'Stanislav Nikitin | Copyright 2017'
    ),
    _react2.default.createElement(
      'p',
      null,
      'Inspired by IOS 7 and Telegram'
    )
  );
};
...
var Header = function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          loadSamples = _props.loadSamples,
          removeContact = _props.removeContact,
          updateQueryString = _props.updateQueryString;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'search-box', onClick: function onClick() {
                return _this2.setState({
                  isSearchBoxVisible: !_this2.state.isSearchBoxVisible
                });
              } },
          ...
          _react2.default.createElement(
            'button',
            { className: 'populate-list', onClick: loadSamples },
            _react2.default.createElement('i', { className: 'fa fa-users' }),
            _react2.default.createElement('i', { className: 'fa fa-plus' })
          ),
          _react2.default.createElement(
            'button',
            { className: 'add-contact', onClick: function onClick() {
                return _this2.setState({
                  isAddFormVisible: !_this2.state.isAddFormVisible
                });
              } },
          ...
          _react2.default.createElement(
            'button',
            { className: 'pull-contacts' },
            _react2.default.createElement('i', { className: 'fa fa-cloud-download' })
          ),
          _react2.default.createElement(
            'button',
            { className: 'push-contacts' },
            _react2.default.createElement('i', { className: 'fa fa-cloud-upload' })
          )
        ),
        _react2.default.createElement('input', { type: 'text', className: 'search-bar', value: this.props.queryString,
          onChange: function onChange(event) {
            var value = event.target.value;
            _this2.props.updateQueryString(value);
          },
          name: 'query', placeholder: '\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0441\u0442\u0440\u043E\u043A\u0443 \u043F\u043E\u0438\u0441\u043A\u0430', hidden: !this.state.isSearchBoxVisible
        }),
        _react2.default.createElement(
          'form',
          { className: 'add-contact', hidden: !this.state.isAddFormVisible,
            onSubmit: function onSubmit(event) {
              event.preventDefault();
              console.log(_this2.state);
              var _state = _this2.state,
                  newName = _state.newName,
                  newImage = _state.newImage,
                  newInfo = _state.newInfo,
                  newTel = _state.newTel,
                  newTelegram = _state.newTelegram;
              ...
              _this2.props.addContact(newName, newItem);
            } },
          _react2.default.createElement(
            'p',
            null,
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'name', value: this.state.newName,
              onChange: function onChange(event) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('textarea', { name: 'image', cols: '30', value: this.state.newImage,
              onChange: function onChange(event) {
                return _this2.setState({ newImage: event.target.value });
              }
            })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement('textarea', { name: 'info', cols: '30', value: this.state.newInfo,
              onChange: function onChange(event) {
                return _this2.setState({ newInfo: event.target.value });
              }
            })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'tel', name: 'tel', value: this.state.newTel,
              onChange: function onChange(event) {
                return _this2.setState({ newTel: event.target.value });
              }
            })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'telegram', value: this.state.newTelegram,
              onChange: function onChange(event) {
                return _this2.setState({ newTelegram: event.target.value });
              }
            })
          ),
          _react2.default.createElement(
  ...
  return Header;
}(_react2.default.Component); // Header class
...
var Contact = function (_React$Component) {
  ...
  _createClass(Contact, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'contact', 'data-name': name },
        _react2.default.createElement(
          'div',
          { className: 'header' },
          _react2.default.createElement(
            'p',
            { 'data-name': name, onClick: this.setState({
          ...
          _react2.default.createElement(
            'button',
            { className: 'edit', 'data-name': name, onClick: this.setState({
          ...
          _react2.default.createElement(
            'button',
            { className: 'remove', 'data-name': name, onClick: removeContact },
            _react2.default.createElement('i', { className: 'fa fa-trash-o' })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'card', hidden: !this.state.isCardVisible },
          _react2.default.createElement('img', { src: 'client/img/' + image, alt: '<img/>' }),
          _react2.default.createElement(
            'p',
            null,
            info
        ...
        _react2.default.createElement(
          'form',
          { className: 'edit-contact', hidden: !this.state.isEditFormVisible,
            onSubmit: function onSubmit(event) {
              event.preventDefault();
              console.log(event);
            } },
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'name', value: this.state.editedName,
              onChange: function onChange(event) {
                return _this2.setState({
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('textarea', { name: 'image', value: this.state.image, cols: '30' })
          ),
          _react2.default.createElement(
            'p',
            null,
            ...
            _react2.default.createElement('textarea', { name: 'info', defaultValue: '\u0412\u0438\u043D \u0414\u0438\u0437\u0435\u043B\u044C \u0441\u0440\u0435\u0434\u0438 \u043E\u0431\u0437\u043E\u0440\u0449\u0438\u043A\u043E\u0432', cols: '30' })
          ),
          _react2.default.createElement(
            'p',
            null,
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'tel', name: 'tel', defaultValue: '1010' })
          ),
          _react2.default.createElement(
            'p',
            null,
            ...
            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'telegram', defaultValue: 'toha10iz10' })
          ),
          _react2.default.createElement(
            'button',
            { type: 'submit' },
  ...
  return Contact;
}(_react2.default.Component); // Contact class
...
var _rootReducer = __webpack_require__(76);

var _rootReducer2 = _interopRequireDefault(_rootReducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = (0, _redux.createStore)(_rootReducer2.default, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
var _contacts = __webpack_require__(77);
...
function rootReducer() {
  ...
  return {
    contacts: (0, _contacts2.default)(state.contacts, action),
    queryString: (0, _queryString2.default)(state.queryString, action)
  };
}
...
function contacts() {
  ...
  switch (action.type) {
    case 'ADD_CONTACT':
      {
        // Parentheses are needed for creating local variables
        var newContacts = new Map(state.contacts); // Clone contacts
    ...
    case 'EDIT_CONTACT':
      {
        // Parentheses are needed for creating local variables
        var _newContacts = new Map(state.contacts); // Clone contacts
        _newContacts.delete(action.oldName);
        _newContacts.set(action.newName, action.item);
    ...
    case 'REMOVE_CONTACT':
      {
        // Parentheses are needed for creating local variables
        var _newContacts2 = new Map(state.contacts); // Clone contacts
        _newContacts2.delete(action.name);
        // Return the new state without the deleted contact
        return _newContacts2;
      }
    default:
      return state;
  }
